            ...
            <label class="form-check-label" for="tagNotForSale">Not For Sale</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                <label for="category_id">Filter Category</label>
                                <select name="filter_category" id="filter_category_id" class="form-control" required>
                                    <option value=""></option>
                                    <option value="cow" {{ $product->filter_category == 'cow' ? 'selected' : '' }}>Cow</option>
                                    <option value="goat" {{ $product->filter_category == 'goat' ? 'selected' : '' }}>Goat</option>
                                    <option value="camel" {{ $product->filter_category == 'camel' ? 'selected' : '' }}>Camel</option>
                                    <option value="hen" {{ $product->filter_category == 'hen' ? 'selected' : '' }}>Hen</option>
                                    <option value="buffalo" {{ $product->filter_category == 'buffalo' ? 'selected' : '' }}>Buffalo</option>
                                    <option value="sea_food" {{ $product->filter_category == 'sea_food' ? 'selected' : '' }}>Sea Food</option>
                                </select>
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                                <label>Long Description<i class="text-danger">*</i></label>
                                <textarea id="long_description" name="long_description" placeholder="{{ __('Enter product long description') }}">{{ $product->long_description }}</textarea>
                                 <!-- Error message -->
                        ...
                        <div class="col-md-12">
                            <h4>{{ __('Preview') }}</h4>
                            <div id="longDescriptionPreview" class="border p-3"></div>
                        </div>
                  
                    <div class="col-md-12">
                            <div class="form-group">
                                <label>Specifications<i class="text-danger">*</i></label>
                                <textarea id="specifications" name="specifications" placeholder="{{ __('Enter product specifications') }}">{{ $product->specifications }}</textarea>
                                 <!-- Error message -->
                        ...
                        <div class="col-md-12">
                            <h4>{{ __('Preview') }}</h4>
                            <div id="specificationsPreview" class="border p-3"></div>
                        </div>
...
$(document).ready(function() {
    ...
    longDescription.summernote({
        ...
        callbacks: {
            onChange: function(contents, $editable) {
                $('#longDescriptionPreview').html(contents);
            }
        }
    });

    // Trigger preview if editing existing description
    const initialContent = longDescription.val();
    if (initialContent) {
        $('#longDescriptionPreview').html(initialContent);
    }
});
$(document).ready(function() {
    ...
    specifications.summernote({
        ...
        callbacks: {
            onChange: function(contents, $editable) {
                $('#specificationsPreview').html(contents);
            }
        }
    });

    // Trigger preview if editing existing description
    const initialContent = specifications.val();
    if (initialContent) {
        $('#specificationsPreview').html(initialContent);
    }
});
