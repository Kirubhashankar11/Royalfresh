            ...
            <label class="form-check-label" for="tagNotForSale">Not For Sale</label>
                    ...
                    <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="long_description" name="long_description" placeholder="{{ __('Enter product long description') }}"></textarea>
                                 <!-- Error message -->
                    ...
                    <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="specifications" name="specifications" placeholder="{{ __('Enter product specifications') }}"></textarea>
                                 <!-- Error message -->
